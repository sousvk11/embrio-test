<div class="app-main flex-column flex-row-fluid">
    ...
    <div class="app-container">
        <div class="digiPageSec pageHead pb-6 d-flex flex-row me-3">
            <!--begin::Title-->
            <div class="col-md-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><i class="fa-solid fa-chevron-right"></i></li>

                    <li class="breadcrumb-item text-muted"><a href="{{ route('digitized') }}">Digitized
                            Logos</a></li>
                    <!--end::Item-->
                </ul>
            </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="gridBox">
                                ...
                                <button class="dotIcon" data-target="#digitizedDetailsBox1" data-dot-open="0"
                                    ...
                                    onclick="openLogoDigitizedDetails()"><i class="fa-solid fa-ellipsis-vertical"
                                        id="digitizedBox"></i>
                                </button>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="gridBox">
                                ...
                                <button class="dotIcon" data-dot-open="0" data-bs-toggle="dropdown"
                                    aria-expanded="false"><i class="fa-solid fa-ellipsis-vertical"></i>
                                </button>
