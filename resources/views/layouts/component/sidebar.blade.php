                    ...
                    <div class="sidebarInnerBox">
                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                <!--begin:Menu sub-->
                                <div
                                    class="menu-sub menu-sub-accordion {{ request()->routeIs('storedashboard') ? 'active' : '' }}">
                                    <!--begin:Menu item-->
                                    <div class="menu-item">
                                        @php
                                        ...
                                        <!--begin:Menu link-->
                                        <a class= "sidebarMenu menu-link mr-0" href="{{ route('storedashboard') }}">
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                <!--begin:Menu sub-->
                                <div
                                    class="menu-sub menu-sub-accordion {{ request()->routeIs('digitized') || request()->routeIs('uploaded-files') ? 'active' : '' }}">
                                    <!--begin:Menu item-->
                                    <div class="menu-item">

                                        <!--begin:Menu link-->
                                        <a class= "sidebarMenu menu-link mr-0" href="Javascript:void(0)"
                                            onclick="toggleClassActive()">
                                            <span class="sidebarMenuImgLibrary"><img
                                                    src="assets/images/icon/library.svg" alt="icon" /></span><span
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg customDropdown {{ request()->routeIs('digitized') || request()->routeIs('uploaded-files') ? 'active' : '' }}"
                                            id="customDropdown">
                                            <!--begin:Menu item-->
                                            <div
                                                class="menu-item sub-item {{ request()->routeIs('digitized') ? 'active' : '' }}">
                                                <!--begin:Menu link-->
                                            ...
                                            <!--begin:Menu item-->
                                            <div
                                                class="menu-item sub-item {{ request()->routeIs('uploaded-files') ? 'active' : '' }}">
                                                <!--begin:Menu link-->
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                <!--begin:Menu sub-->
                                <div
                                    class="menu-sub menu-sub-accordion {{ request()->routeIs('store') ? 'active' : '' }}">
                                    <!--begin:Menu item-->
                                    <div class="menu-item">

                                        <!--begin:Menu link-->
                                        <a class= "sidebarMenu menu-link mr-0" href="{{ route('store') }}">
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                <!--begin:Menu sub-->
                                <div
                                    class="menu-sub menu-sub-accordion {{ request()->routeIs('storeproducts') ? 'active' : '' }}">
                                    <!--begin:Menu item-->
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class= "sidebarMenu menu-link mr-0" href="{{ route('storeproducts') }}">
